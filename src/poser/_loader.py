...
try: 
    ...
    torch = None
    print("torch not available. some features will not work.")
...
if torch is not None:
    ...
    # define dummy version - so pytest can import your module without torch being there. 
    class ZebData:
        def __init__(self, *args, **kwargs):
            raise ImportError("ZebData cannot be used without torch installed.")
