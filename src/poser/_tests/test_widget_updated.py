...
class TestJumpToEvent:
    ...
    def test_jump_to_existing_behaviour(self, mock_instance):
        ...
        mock.jump_to_event(event)
        mock.viewer.dims_set_point.asset_called()
        mock.add_behaviour_from_selected_area.assert_not_called()
    ...
    def test_jump_to_new_behaviour(self, mock_instance): 
        ...
        mock.jump_to_event(event)
        mock.add_behaviour_from_selected_area.assert_called_once()
